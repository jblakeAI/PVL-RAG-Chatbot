...
**Reranker model** - Mistral-7B-Instruct (quantized):
...
* Run tests for similarity\_search threshold value to reduce
* Add code to prevent disruption when LLM get deprecated
* 
